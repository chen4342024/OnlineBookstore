...
public class CatagoryAction extends BaseAction {
  ...
  private List<Catagory> firstCatagoryList;
   ...
   */
  public void findCatagoryIncludeChildByName() throws UnsupportedEncodingException {
    String catagory_name =  catagory.getCatagory_name();
    Catagory parentCatagory = catagoryService.find(catagory_name);
    if(!parentCatagory.isParentCatagory()){
      parentCatagory = parentCatagory.getCatagory_parent();
    }
    List<Catagory> secondCatagoryList = parentCatagory.getSecondCatagoryList();
    secondCatagoryList.addAll(catagoryService.findAll(parentCatagory.getCatagory_id()));
    parentCatagory.setSecondCatagoryList(secondCatagoryList);
    this.firstCatagoryList = new ArrayList<Catagory>();
    this.firstCatagoryList.add(parentCatagory);
    HttpServletRequest request = ServletActionContext.getRequest();
    request.setAttribute("firstCatagoryList",this.firstCatagoryList);
  }

  public String findAllCatagory() {
    this.firstCatagoryList = catagoryService.findAllFirstCatagory();
    for (Catagory parentCatagory : firstCatagoryList) {
      List<Catagory> secondCatagoryList = parentCatagory.getSecondCatagoryList();
      secondCatagoryList.addAll(catagoryService.findAll(parentCatagory.getCatagory_id()));
      parentCatagory.setSecondCatagoryList(secondCatagoryList);
    }
  ...
  public List<Catagory> getFirstCatagoryList() {
    return firstCatagoryList;
  }

  public void setFirstCatagoryList(List<Catagory> firstCatagoryList) {
    this.firstCatagoryList = firstCatagoryList;
  }
